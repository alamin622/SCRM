            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('employeepost.index') }}">Representative Visiting History list</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('employeepost.index') }}" class="btn btn-primary">Go Back to Representative Visiting History List</a>
                            </div>
                        </div>
