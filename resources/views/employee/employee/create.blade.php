                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Create HRM Employee</h3>
                                <a href="{{ route('employeeemployee.index') }}" class="btn btn-primary">Go Back to HRM Employee List</a>
                            </div>
                        </div>
                                    <form action="{{ route('employeeemployee.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password"  value="{{ old('password_confirm') }}" class="form-control" name="password_confirm" id="password_confirm" placeholder="Confirm Password">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="emp_id" > Employee ID</label>
                                                                <input type="text"  value="{{ old('emp_id') }}" class="form-control" name="emp_id" id="emp_id" placeholder="Emp id">
                                                            </div>
