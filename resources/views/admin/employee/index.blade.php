                    ...
                    <div id="" class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('employee.create') }}" class="btn btn-primary">Create HRM Employee</a>
                            </div>
                                ...
                                @if($employees->count())
                                    ...
                                    @foreach ($employees as $employee)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('employee.show', [$employee->id]) }}" class="btn btn-sm btn-success mr-1"> <i class="fas fa-eye"></i> </a>


                                                    <a href="{{ route('employee.edit', [$employee->id]) }}" class="btn btn-sm btn-primary mr-1"> <i class="fas fa-edit"></i> </a>
                                                    <form action="{{ route('employee.destroy', [$employee->id]) }}" class="mr-1" method="POST">
                                                        @method('DELETE')
                                                        @csrf
