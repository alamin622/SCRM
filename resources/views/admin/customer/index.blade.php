                    ...
                    <div id="" class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('customer.create') }}" class="btn btn-primary">Create Profile management Info</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                ...
                                @if($customers->count())
                                    ...
                                    @foreach ($customers as $customer)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('customer.show', [$customer->id]) }}" class="btn btn-sm btn-success mr-1"> <i class="fas fa-eye"></i> </a>
                                                <a href="{{ route('customer.edit', [$customer->id]) }}" class="btn btn-sm btn-primary mr-1"> <i class="fas fa-edit"></i> </a>

                                                <form action="{{ route('customer.destroy', [$customer->id]) }}" class="mr-1" method="POST">
                                                    @method('DELETE')
                                                    @csrf
