...
class CreateDivisionalInchargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('divisional_incharges', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
    ...
    {
        Schema::dropIfExists('divisional_incharges');
    }
}
