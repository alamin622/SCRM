...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('employee.employee.create', compact(['divisions', 'zones', 'areas', 'users', 'roles']));
    }
    ...
    public function edit($id)
    {
        ...
        $areas = Area::all();
        $users = User::with(['employee'])->get();
        return view('employee.employee.edit', compact(['employee', 'divisions', 'zones', 'areas', 'users']));
    }
