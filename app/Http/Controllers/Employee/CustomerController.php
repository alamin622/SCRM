...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.customer.index', compact('customers'));
    }
    ...
    public function create()
    {
        ...
        $areas = Area::all();
        return view('employee.customer.create', compact(['types', 'divisions', 'zones', 'areas', 'categories']));
    }
    ...
    public function show($id)
    {
        ...
        return view('employee.customer.show', compact('customer'));
    }
    ...
    public function edit($id)
    {
        ...
        $zones = Zone::with(['areas'])->get();
        $areas = Area::all();
        return view('employee.customer.edit', compact(['customer', 'types', 'divisions', 'zones', 'areas', 'categories']));
    }
